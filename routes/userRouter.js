...
import { register, login, logout, currentUser, updateSubscription, verifyEmail } from '../controllers/authControllers.js';
...
userRouter.patch('/subscription', checkAuth, validateBody(subscriptionUserSchema), updateSubscription)
userRouter.patch('/avatars', checkAuth, uploadMiddleware.single("avatar"), uploadAvatar)
